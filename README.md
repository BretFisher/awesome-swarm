...
- 2025-08 - [Portainer - Technical Advisory: Docker Swarm](https://www.portainer.io/blog/technical-advisory-docker-swarm) - Upgrade guidance for Docker Engine API v49 compatibility changes affecting Swarm volumes, iptables, overlay networks, VXLAN, and related API clients/plugins.
...
- [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769)**
- [Docker Volume plugin for RBD (Ceph)](https://github.com/wetopi/docker-volume-rbd) - Docker Engine managed plugin to for RBD Ceph volumes.
